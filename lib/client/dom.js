...
(function(Util, DOM){
    ...
    DOM.getCurrentFile          = function(pCurrentFile){
        var lRet = pCurrentFile || DOM.getByClass(CURRENT_FILE )[0];
    ...
    DOM.getCurrentSize          = function(pCurrentFile){
        var lRet,
            lCurrent = DOM.getCurrentFile(pCurrentFile),
   ...
   /**
    ...
    DOM.getCurrentLink          = function(pCurrentFile){
        var lLink = DOM.getByTag( 'a', DOM.getCurrentFile(pCurrentFile) ),
    ...
    DOM.getCurrentPath          = function(pCurrentFile){
        var lCurrent    = DOM.getCurrentFile( pCurrentFile ),
