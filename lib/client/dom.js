...
(function(Util) {
    ...
    var DOMFunc                     = function() {},
        ...
        RESTfulProto                = function() {
            this.delete = function(url, pData, pCallBack, pQuery) {
                sendRequest({
                    method      : 'DELETE',
            ...
            this.save   = function(url, pData, pCallBack, pQuery) {
                sendRequest({
                    method      : 'PUT',
                    url         : CloudFunc.FS + url + (pQuery || ''),
                    data        : pData,
        ...
        CmdProto                    = function() {
             ...
             * @currentFile
             */
             this.saveCurrentData             = function(url, pData, pCallBack, pQuery) {
                RESTful.save(url, pData, function() {
                    DOM.saveDataToStorage(url, pData);
                }, pQuery);
            };
             ...
             */
            this.setHistory              = function(pData, pTitle, url) {
                var lRet = window.history;
                
                if (lRet)
                    history.pushState(pData, pTitle, url);
