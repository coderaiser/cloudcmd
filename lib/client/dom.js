    ...
    var DOMFunc                     = function() {},
        ...
        EventsProto                 = function() {
            var Events      = this,
                ...
                parseArgs = function(eventName, listener, element, useCapture, callback) {
                    var type            = Util.getType(eventName);
             ...
             */
            this.add                        = function(type, listener, useCapture, element) {
                parseArgs(type, listener, useCapture, element, function(element) {
            ...
            this.addOnce                    = function(type, listener, element, useCapture) {
                var once    = function (event) {
                        Events.remove(type, once, element, useCapture);
                        listener(event);
                    };
                
                this.add(type, once, element, useCapture);
             ...
             * @param element {document by default}
             */
            this.remove                     = function(type, listener, useCapture, element) {
                parseArgs(type, listener, useCapture, element, function(element) {
                    var args = Util.slice(arguments, 1);
             ...
             * @param useCapture
             */
            this.addLoad                   = function(listener, element, useCapture) {
                return this.add('load', listener, element, useCapture);
            };
