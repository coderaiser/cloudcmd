...
(function(Util) {
    ...
    var DOMFunc                     = function() {},
        ...
        RESTfulProto                = function() {
            this.delete = function(url, data, callback, pQuery) {
                sendRequest({
                    method      : 'DELETE',
            ...
            this.save   = function(url, data, callback, pQuery) {
                sendRequest({
                    method      : 'PUT',
                    url         : CloudFunc.FS + url + (pQuery || ''),
                    data        : data,
            ...
            this.read   = function(url, callback, pQuery) {
                sendRequest({
                    method      : 'GET',
                    url         : CloudFunc.FS + url + (pQuery || ''),
                    callback    : callback
        ...
        CmdProto                    = function() {
             ...
             * @currentFile
             */
             this.saveCurrentData             = function(url, data, callback, pQuery) {
