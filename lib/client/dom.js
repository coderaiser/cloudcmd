...
(function(Util) {
    ...
    var DOMFunc                     = function() {},
        ...
        RESTfulProto                = function() {
            this.delete = function(url, data, pCallBack, pQuery) {
                sendRequest({
                    method      : 'DELETE',
                    url         : CloudFunc.FS + url + (pQuery || ''),
                    data        : data,
                    callback    : pCallBack,
            ...
            this.save   = function(url, data, pCallBack, pQuery) {
                sendRequest({
                    method      : 'PUT',
                    url         : CloudFunc.FS + url + (pQuery || ''),
                    data        : data,
            ...
            this.read   = function(url, pCallBack, pQuery) {
                sendRequest({
                    method      : 'GET',
                    url         : CloudFunc.FS + url + (pQuery || ''),
                    callback    : pCallBack
             ...
             this.cp     = function(data, pCallBack) {
                sendRequest({
                    method      : 'PUT',
                    url         : '/cp',
                    data        : data,
            ...
            this.zip    = function(data, pCallBack) {
                sendRequest({
                    method      : 'PUT',
                    url         : '/zip',
                    data        : data,
            ...
            this.mv     = function(data, pCallBack) {
                sendRequest({
                    method      : 'PUT',
                    url         : '/mv',
                    data        : data,
            ...
            this.config    = function(data, pCallBack) {
                sendRequest({
                    method      : 'PUT',
                    url         : '/config',
                    data        : data,
        ...
        CmdProto                    = function() {
             ...
             * @currentFile
             */
             this.saveCurrentData             = function(url, data, pCallBack, pQuery) {
                RESTful.save(url, data, function() {
